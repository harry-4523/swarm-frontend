  ...
  return (
    <div style={{ background:'var(--bg)', color:'var(--text-1)', fontFamily:'var(--font-b)', overflowX:'hidden' }}>
      ...
      <header style={N.nav}>
        ...
        <button ref={ctaRef} style={N.cta} onClick={() => navigate('/dashboard')}>
        ...
        <div style={H.inner}>
          ...
          <div style={H.left}>
            ...
            <div style={H.actions} className="reveal stagger-5">
              <button style={H.primary} onClick={() => navigate('/dashboard')}>
                Open Control Room
              </button>
      ...
      <section style={C.section}>
        <div style={C.inner}>
          ...
          <div style={C.btns} className="reveal stagger-2">
            <button style={C.primary} onClick={() => navigate('/dashboard')}>Open Control Room →</button>
